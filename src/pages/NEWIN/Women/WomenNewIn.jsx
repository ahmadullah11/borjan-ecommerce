...
import NewWomenQuickAddModel from "./NewWomenQuickAddModel";
...
const ProductCard = ({ product }) => {
  ...
  return (
    <>
      ...
      {showModal && (
        <NewWomenQuickAddModel product={product} onClose={() => setShowModal(false)} />
      )}
    </>
  );
};
    ...
    <section className="w-full bg-white">
      <div className="pt-12 px-2 sm:px-3">
        <div className="text-center mb-6">
          ...
          <p>A range of women shoes from casual to party to formal wear. </p>
        </div>
