...
import NewWomenShoppingCart from "./NewWomenShoppingCart";

export default function NewWomenProductDetail() {
  ...
  return (
    <div className="relative min-h-screen bg-white p-6 lg:p-12">
      {/* ✅ Cart Drawer */}
      {showCart && <NewWomenShoppingCart onClose={() => setShowCart(false)} />}
