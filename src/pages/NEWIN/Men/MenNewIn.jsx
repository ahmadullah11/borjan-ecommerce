...
import NewMenShoppingCart from "./NewMenShoppingCart";
import { IoColorFilterOutline } from "react-icons/io5";
import NewMenQuickAddModel from "./NewMenQuickAddModel";
    ...
    <>
      ...
      >
        <div className="relative">
          {/* ✅ Image updated to show full image (not cropped) */}
          <img
          ...
          {isHovered && (
            <div className="absolute inset-x-0 bottom-0 transition-all duration-300">
              ...
              >
                {isQuickShopHovered ? (
                  <NewMenShoppingCart className="w-5 h-5" />
                ) : (
      ...
      {showModal && <NewMenQuickAddModel product={product} onClose={() => setShowModal(false)} />}
    </>
  );
};

// ✅ Main MenNewIn Component
const MenNewIn = () => {
