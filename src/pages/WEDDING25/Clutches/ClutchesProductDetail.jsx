...
import ClutchesShoppingCart from "./ClutchesShoppingCart";

export default function ClutchesProductDetail() {
  ...
  return (
    <div className="relative min-h-screen bg-white p-6 lg:p-12">
      {/* ✅ Cart Drawer */}
      {showCart && <ClutchesShoppingCart onClose={() => setShowCart(false)} />}
