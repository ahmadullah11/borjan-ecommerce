...
import SlippersShoppingCart from "./SlippersShoppingCart";

export default function SlippersProductDetail() {
  ...
  return (
    <div className="relative min-h-screen bg-white p-6 lg:p-12">
      {/* ✅ Cart Drawer */}
      {showCart && <SlippersShoppingCart onClose={() => setShowCart(false)} />}
