...
import SkywalkQuickAddModel from "./SkywalkQuickAddModel";
...
const ProductCard = ({ product }) => {
  ...
  return (
    <>
      ...
      {showModal && (
        <SkywalkQuickAddModel product={product} onClose={() => setShowModal(false)} />
      )}
    </>
  );
};
    ...
    <section className="w-full bg-white">
      <div className="pt-12 px-2 sm:px-3">
        <div className="text-center mb-6">
          ...
          <p>
            Skywalk features a range of comfort slippers, mules, moccasins and sandals for women. 
            </p>
        </div>
