...
import HeelsQuickAddModel from "./HeelsQuickAddModel";
...
const ProductCard = ({ product }) => {
  ...
  return (
    <>
      ...
      {showModal && (
        <HeelsQuickAddModel product={product} onClose={() => setShowModal(false)} />
      )}
    </>
  );
};
    ...
    <section className="w-full bg-white">
      <div className="pt-12 px-2 sm:px-3">
        <div className="text-center mb-6">
          ...
          <p>Our range of heels has it all covered, from high, mid to low heel sizes.</p>
        </div>
