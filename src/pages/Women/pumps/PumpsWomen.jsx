...
import PumpsQuickAddModel from "./PumpsQuickAddModel";
...
const ProductCard = ({ product }) => {
  ...
  return (
    <>
      ...
      {showModal && (
        <PumpsQuickAddModel product={product} onClose={() => setShowModal(false)} />
      )}
    </>
  );
};
    ...
    <section className="w-full bg-white">
      <div className="pt-12 px-2 sm:px-3">
        <div className="text-center mb-6">
          ...
          <p>
            Pumps ranging from everyday to party wear. 
            </p>
        </div>
