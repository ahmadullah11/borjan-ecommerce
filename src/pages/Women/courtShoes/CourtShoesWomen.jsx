...
import CourtShoesQuickAddModel from "./CourtShoesQuickAddModel";
...
const ProductCard = ({ product }) => {
  ...
  return (
    <>
      ...
      {showModal && (
        <CourtShoesQuickAddModel product={product} onClose={() => setShowModal(false)} />
      )}
    </>
  );
};

const CourtShoesWomen = () => {
    ...
    <section className="w-full bg-white">
      <div className="pt-12 px-2 sm:px-3">
        <div className="text-center mb-6">
          ...
          <p>
            The shoes rightfully designed for the Girl-Boss that you are! These shoes usually do not cover the top part of the foot and are made of plain leather with minimal design to make it perfect for formal wear. 
            </p>
        </div>
...
export default CourtShoesWomen;
