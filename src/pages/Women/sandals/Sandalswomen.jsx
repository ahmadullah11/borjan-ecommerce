...
import SandalsQuickAddModel from "./SandalsQuickAddModel";
...
const ProductCard = ({ product }) => {
  ...
  return (
    <>
      ...
      {showModal && (
        <SandalsQuickAddModel product={product} onClose={() => setShowModal(false)} />
      )}
    </>
  );
};
    ...
    <section className="w-full bg-white">
      <div className="pt-12 px-2 sm:px-3">
        <div className="text-center mb-6">
          ...
          <p>Sandals that provide affordability and a fashion choice with varied designs. kw</p>
        </div>
