...
import SneakersShoppingCart from "./SneakersShoppingCart";

export default function SneakersProductDetail() {
  ...
  return (
    <div className="relative min-h-screen bg-white p-6 lg:p-12">
      {/* ✅ Cart Drawer */}
      {showCart && <SneakersShoppingCart onClose={() => setShowCart(false)} />}
