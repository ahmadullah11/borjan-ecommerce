...
import MoccasinsShoppingCart from "./MoccasinsShoppingCart";

export default function MoccasinsProductDetail() {
  ...
  return (
    <div className="relative min-h-screen bg-white p-6 lg:p-12">
      {/* ✅ Cart Drawer */}
      {showCart && <MoccasinsShoppingCart onClose={() => setShowCart(false)} />}
