    ...
    >
      ...
      <div className="relative">
        <img 
          ...
          // ⬆ h-80 instead of aspect-square for bigger height
        />

        {/* Hover Overlay with Sizes and Quick Shop */}
        {isHovered && (
...
<div className="p-4 bg-white text-center">
  <h3 className="text-sm font-medium mb-2 hover:underline cursor-pointer">
    {product.name}
  </h3>
  ...
  <div className="flex justify-center">
    <div className="bg-purple-100 text-purple-700 px-2 py-1 rounded flex items-center gap-1 text-xs">
      ...
      <span className="font-medium">
        Pay only Rs. {Math.floor(product.salePrice / 3).toLocaleString()} now
      </span>
    </div>
  </div>
</div>
...
export default FavoritesSaleSection;
