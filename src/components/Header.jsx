  ...
  const menus = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { name: "Heels", link: "heelswomen" },
        { name: "Chappals", link: "/chappalswomen" },
        { name: "Khussa", link: "/khussawomen" },
        { name: "Court Shoes", link: "/court-shoeswomen" },
        { name: "Skywalk", link: "/Skywalkwomen" },
        { name: "Sneakers", link: "/sneakerswomen" },
        { name: "Pumps", link: "/pumpswomen" },
        { name: "Moccasins", link: "/moccasinswomen" },
        { name: "Mules", link: "/muleswomen" },
        { name: "Party Wear", link: "/party-wearwomen" },
        { name: "Platforms", link: "/platformswomen" },
        {
          name: "Accessories",
          submenu: [
